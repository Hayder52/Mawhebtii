...
public class personnes {
    ...
    public personnes(int id, String nom, String prenom, String adresse, String num_tel, String login, String password,int age) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
...
public personnes(){
 ...
 public void setAge(int age) {
    ...
    public String toString() {
        return "personnes{" + "id=" + id + ", nom=" + nom + ", prenom=" + prenom + ", adresse=" + adresse + ", num_tel=" + num_tel + ", login=" + login + ", password=" + password +"age:"+age+ '}';
    }
